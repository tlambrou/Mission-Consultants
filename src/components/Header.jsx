            ...
            <div className="container">
              <div className="row">
                <div className="col-md-8 offset-md-2 text-center">
                  ...
                  <h5 className="description">We're Mission Consultants: a consortium of elite engineers and designers providing versatile professional solutions in full-stack web, iOS, and graphical and product design.</h5>
                  <br/>
                </div>
